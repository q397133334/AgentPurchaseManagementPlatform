...
import { UserServiceProxy, UserDto, RoleDto , OrderListDtoState} from '@shared/service-proxies/service-proxies';
...
export class EditUserComponent extends AppComponentBase {
    ...
    show(id: number): void {
        forkJoin([this._userService.getRoles(), this._userService.get(id)])
            .subscribe(results => {

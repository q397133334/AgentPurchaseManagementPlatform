...
namespace AgentPurchaseManagementPlatform.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly AgentPurchaseManagementPlatformDbContext _context;

        public HostRoleAndUserCreator(AgentPurchaseManagementPlatformDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AgentPurchaseManagementPlatformAuthorizationProvider())
